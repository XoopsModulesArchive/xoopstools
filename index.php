...
include(XOOPS_ROOT_PATH."/modules/xoopstools/language/english/lang-english.php");
if ($xoopsConfig['startpage'] == "xoopstools") {
...
echo "<br>";
OpenTable();
echo "<center><h4>Xoops Tools</h4></center>";
CloseTable();
echo "<br>";
OpenTable();

echo "<CENTER>";
echo "<TABLE height='212' cellSpacing='0' cellPadding='0' width='100%' border='0'>";
echo "<tbody>";
echo "<TD vAlign='top' align='middle' width='30%' height='212'><BR>";
echo "<a href='index.php?func=HTMLPHP'>"._HTMLC."</a><br><br>";
echo "<a href='index.php?func=HTMLASP'>"._HTMLASP."</a><br><br>";
echo "<a href='index.php?func=HTMLJSP'>"._HTMLJSP."</a><br><br>";
echo "<a href='index.php?func=HTMLPERL'>"._HTMLPERL."</a><br><br>";
echo "<a href='index.php?func=HTMLJS'>"._HTMLJS."</a><br><br>";
echo "<a href='index.php?func=HTMLSWS'>"._HTMLSWS."</a><br><br>";
echo "<a href='index.php?func=HTMLEDITOR'>"._EDITORC."</a><br><br>";
echo "<a href='index.php?func=METATAGS'>"._METAC."</a><br><br>";
echo "</td>";
echo "<TD vAlign='top' align='middle' width='30%' height='212'><BR>";
echo "<a href='index.php?func=IESCROLL'>"._SCROLLC."</a><br><br>";
echo "<a href='index.php?func=POPUP'>"._POPUP."</a><br><br>";
echo "<a href='index.php?func=COLOR'>"._HEXC."</a><br><br>";
echo "<a href='index.php?func=PREVIEWER'>"._PREVIEWER."</a><br><br>";
echo "<a href='index.php?func=SOURCECODER'>"._SCODER."</a><br><br>";
echo "<a href='index.php?func=HTMLENCODER'>"._HTMLCODER."</a><br><br>";
echo "<a href='index.php?func=URLENCODER'>"._URLCODER."</a><br><br>";
echo "<a href='index.php?func=EMAILENCODER'>"._EMAILCODER."</a><br><br>";
echo "<a href='index.php?func=ROT'>"._ROTCODER."</a><br><br>";
...
function exHTMLPHP()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLPHP.js");
...
function exHTMLASP()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLASP.js");
...
function exHTMLJSP()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLJSP.js");
...
function exHTMLPERL()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLPERL.js");
...
function exHTMLJS()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLJS.js");
...
function exHTMLSWS()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLSWS.js");
...
#  function HTMLEDITOR
#####################################################
function exHTMLEDITOR()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLEDITOR.js");
...
echo ("<center><br><h4>"._EDITORC."</h4><BR><BR>")
  ...
  . "<i>"
  . "<input type=\"button\" value=\" "._ABOUT." \" onClick=\"alert('By Joe, (C) Rojak.org 2004')\">"
  . "</i>"
  . "</td>"
  . "</tr>"
  . "<tr>"
  ...
  . "</td>"
  . "<td align=center>"
  . "<small>Copyright 2004 by Joe (www.rojak.org)</small>"
  . "</td>"
  . "</tr>"
  . "</table>"
  . "<p> "
...
function exMETATAGS()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exMETATAGS.js");
...
function exIESCROLL()  {
global $xoopsTheme;
//include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exIESCROLL.js");
...
echo " <center><td><br><h4>"._SCROLLC."</h4><BR>"
  ...
  . "</script>"
  . ""
  . "<div align=\"center\"><script language=\"JavaScript\" src='js/exIESCROLL.js'></script></div>";
CloseTable();
}
...
function exCOLOR()  {
global $xoopsTheme;
//include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exCOLOR.js");
...
#  function PREVIEWER
#####################################################
function exPREVIEWER()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exPREVIEWER.js");
...
#####################################################
function exSOURCECODER()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exSOURCECODER.js");
...
#####################################################
function exHTMLENCODER()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exHTMLENCODER.js");
...
#  function URLENCODER
#####################################################
function exURLENCODER()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exURLENCODER.js");
...
#####################################################
function exEMAILENCODER()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exEMAILENCODER.js");
...
function exROT()  {
global $xoopsTheme;
include(XOOPS_ROOT_PATH."/modules/xoopstools/js/exROT.js");
